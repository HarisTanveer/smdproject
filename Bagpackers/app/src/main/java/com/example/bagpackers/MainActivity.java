...
public class MainActivity extends AppCompatActivity {
    ...
    public class DataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            db.placeDao().insert(khaplu);
            db.hotelDao().insert(a);
            db.hotelDao().insert(b);
            db.hotelDao().insert(c);
            db.hotelDao().insert(e);
            ...
            Place kachura = new Place("Kachura Lake", "Gilgit-Baltistan", d, "android.resource://com.example.bagpackers/drawable/kachura");
            ...
            Place fairy = new Place("Fairy Meadows", "Gilgit-Baltistan", d, "android.resource://com.example.bagpackers/drawable/fairy");
            ...
            Place deosai = new Place("Astore", "Gilgit-Baltistan", d, "android.resource://com.example.bagpackers/drawable/deosai");
